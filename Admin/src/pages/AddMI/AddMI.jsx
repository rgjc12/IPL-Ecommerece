...
function AddMI({token}) {
  ...
  const onSubmit = async(e)=>{
    ...
    try{
      ...
      const response = await axios.post(`${backendUrl}/api/miproduct/addmi`,formData,{
        headers: {
      ...
      {
        toast.success('MI Product Added Successfully!');
      }
      else 
      {
  ...
  return (
    <>
    <div id="addmimain">
      <form id="addmiform" encType="multipart/form-data">
      <div id="uploadimages">
          <p>Upload Images:</p>
        ...
        <button id="addmibutton" type="submit" onClick={onSubmit}>Add </button>
